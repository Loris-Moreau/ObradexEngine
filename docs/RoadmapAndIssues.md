...
| Esc Key should exit inventory and opening inventory should pause the game | Open   | need to add another ecxeption to esc key, and in inventory open need to pause game                                                                                                                                                                                                   |
